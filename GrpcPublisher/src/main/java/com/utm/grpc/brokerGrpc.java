...
public final class brokerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.utm.grpc.Broker.Subject,
      com.utm.grpc.Broker.ResponseMessage> getPublishMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "publish",
      requestType = com.utm.grpc.Broker.Subject.class,
      responseType = com.utm.grpc.Broker.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.utm.grpc.Broker.Subject,
      com.utm.grpc.Broker.ResponseMessage> getPublishMethod() {
    io.grpc.MethodDescriptor<com.utm.grpc.Broker.Subject, com.utm.grpc.Broker.ResponseMessage> getPublishMethod;
      ...
      synchronized (brokerGrpc.class) {
        if ((getPublishMethod = brokerGrpc.getPublishMethod) == null) {
          brokerGrpc.getPublishMethod = getPublishMethod = 
              io.grpc.MethodDescriptor.<com.utm.grpc.Broker.Subject, com.utm.grpc.Broker.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "broker", "publish"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.utm.grpc.Broker.Subject.getDefaultInstance()))
  ...
  public static abstract class brokerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void publish(com.utm.grpc.Broker.Subject request,
  ...
  public static final class brokerBlockingStub extends io.grpc.stub.AbstractStub<brokerBlockingStub> {
    ...
    /**
     */
    public com.utm.grpc.Broker.ResponseMessage publish(com.utm.grpc.Broker.Subject request) {
  ...
  public static final class brokerFutureStub extends io.grpc.stub.AbstractStub<brokerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.utm.grpc.Broker.ResponseMessage> publish(
        com.utm.grpc.Broker.Subject request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUBLISH:
          serviceImpl.publish((com.utm.grpc.Broker.Subject) request,
              (io.grpc.stub.StreamObserver<com.utm.grpc.Broker.ResponseMessage>) responseObserver);
          break;
        default:
